...
import com.example.theworldhistory.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void setListeners() {
        binding.signUpToSignIn.setOnClickListener(v -> onBackPressed());
        binding.signUpButton.setOnClickListener(v -> {
            if (isValidSignUpDetails()) {
                signUp();
            }
        });
        binding.layoutSignUpAvatarUser.setOnClickListener( v-> {
    ...
    private void signUp() {
        ...
        user.put(Constants.KEY_FIRSTNAME, binding.signUpFirstname.getText().toString());
        user.put(Constants.KEY_SURNAME, binding.signUpSurname.getText().toString());
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.putString(Constants.KEY_FIRSTNAME, binding.signUpFirstname.getText().toString());
                    preferenceManager.putString(Constants.KEY_SURNAME, binding.signUpSurname.getText().toString());
                ...
                if (result.getResultCode() == RESULT_OK) {
                    if (result.getData() != null) {
                        ...
                        try {
                            ...
                            binding.signUpAvatarUser.setImageBitmap(bitmap);
    ...
    private Boolean isValidSignUpDetails() {
        if(encodedImage == null) {
            showToast("Выберите аватар");
            return false;
        } else if (binding.signUpFirstname.getText().toString().trim().isEmpty()) {
            showToast("Введите имя");
            return false;
        } else if (binding.signUpSurname.getText().toString().trim().isEmpty()) {
