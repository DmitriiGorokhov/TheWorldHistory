...
import com.example.theworldhistory.databinding.ItemContainerUserBinding;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UserViewHolder> {
    ...
    class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        void setUserData(User user) {
            binding.supportFirstname.setText(user.firstname);
            binding.supportSurname.setText(user.surname);
            binding.supportEmail.setText(user.email);
            binding.supportProfileAvatar.setImageBitmap(getUserAvatar(user.image));
